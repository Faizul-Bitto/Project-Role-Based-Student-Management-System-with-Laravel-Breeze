        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 flex">
            ...
            <div class="w-60 bg-gray-600 text-gray-100 flex flex-col rounded-lg shadow-md">
                ...
                <ul class="flex-1">
                    ...
                    <li class="p-4 hover:bg-gray-700 rounded-md">
                        <a href="{{ route('student.dashboard.index') }}" class="text-white">Show Users</a>
                    </li>
                    <li class="p-4 hover:bg-gray-700 rounded-md">
            ...
            <div class="flex-1 ml-6 bg-white p-8 shadow-lg rounded-lg">
                <h3 class="text-lg font-semibold text-gray-700 mb-4">Create a New Guest User</h3>
                ...
                <form method="POST" action="{{ route('student.guests.store') }}" enctype="multipart/form-data"
                    ...
                    <!-- Student ID -->
                    <div id="student_id_field" class="hidden" aria-live="polite">
                ...
                <!-- Script to toggle Student ID field -->
                <script>
                    document.getElementById('role').addEventListener('change', function() {
                        ...
                        if (this.value === 'Student') {
                            ...
                            studentIdInput.value = ''; // Clear value if not a student
                        }
                    });
